...
// --- Konfigurasi Anda ---
const YOUR_DOMAIN = 'https://rameindo.pages.dev'; // Ganti dengan domain Anda yang sebenarnya
const API_KEY_NAME = '3e675326-3e7e-42f6-b8e8-d29065704dcf'; // Ganti dengan GUID Anda
